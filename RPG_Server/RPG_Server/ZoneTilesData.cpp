...
void ZoneTilesData::GetMap(const char * _name)
{
...
Tile** ZoneTilesData::GetMap()
{
	return m_Map;
}

int ZoneTilesData::GetMapSizeX()
{
	return m_mapSizeX;
}

int ZoneTilesData::GetMapSizeY()
{
	return m_mapSizeY;
}

Tile* ZoneTilesData::GetTile(int _x, int _y)
{
