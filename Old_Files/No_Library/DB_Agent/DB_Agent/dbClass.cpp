...
bool dbClass::Connect(const char *host,
	const char *username,
	const char *password,
	const char *database,
...
bool dbClass::SelectDB(const char* DBname)
{
	return mysql_select_db(&connect, DBname);
}

bool dbClass::OverlappedCheck(const char* id, const char* password, int &_userId)
{
	MYSQL_ROW mysql_row;
...
bool dbClass::InsertData(const char* id, const char* password)
{
	MYSQL_ROW mysql_row;
...
bool dbClass::GetUserInfo(const int& _userId,
...
bool dbClass::UpdateUserInfo(const int& _userId, int _level,
	int _curHp, int _maxHp, int _curMp, int _maxMp, int _curExp, int _maxExp,
	int _atk, int _def)
{
	MYSQL_ROW mysql_row;
...
bool dbClass::GetMonsterInfo(WORD& _monsterType, int& _curHp, int& _maxHp,
...
void dbClass::Query(const char* tableName)
{
