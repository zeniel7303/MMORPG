...
--
-- Table structure for table `monstertable`
--

DROP TABLE IF EXISTS `monstertable`;
...
CREATE TABLE `monstertable` (
  ...
  `patrolDelay` float NOT NULL,
  `returnDistance` float NOT NULL,
...
--
-- Dumping data for table `monstertable`
--

LOCK TABLES `monstertable` WRITE;
/*!40000 ALTER TABLE `monstertable` DISABLE KEYS */;
INSERT INTO `monstertable` VALUES (1,100,2.5,20,1,3,5,10,20,40);
/*!40000 ALTER TABLE `monstertable` ENABLE KEYS */;
UNLOCK TABLES;
